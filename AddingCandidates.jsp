		...
		<section class="modal-dialog">
			...
			<section class="modal-content">
				...
				<section class="modal-body" style="padding: 40px 50px;">
					<form role="form" action="CreateCandidate"
						enctype="multipart/form-data" method="post">
						<section class="form-group">
							<label for="psw"><span class="glyphicon glyphicon-user"></span>Candidate
								ID</label> <input type="text" class="form-control" name="cid"
								placeholder="Enter Candidate Id" required>
						</section>
						<section class="form-group">
							<label for="psw"><span class="glyphicon glyphicon-user"></span>Election
								ID</label> <input type="text" class="form-control" name="eid"
								placeholder="Enter Election Id" required>
						</section>
						<section class="form-group">
							<label for="psw"><span class="glyphicon glyphicon-user"></span>Candidate Name
								</label> <input type="text" class="form-control" name="cname"
								placeholder="Enter Election Id" required>
						</section>
						...
						<section class="form-group">
							<label for="email"><span class="glyphicon glyphicon-user"></span>Email
								ID</label> <input type="text" class="form-control" name="emailid"
								placeholder="Enter Email Id" required>
						</section>

						<section class="form-group">
							<label for="post"><span class="glyphicon glyphicon-user"></span>Photo</label>
							<input type="file" name="image" required />
						</section>
						<section class="form-group">
							<label for="start_time"><span
								class="glyphicon glyphicon-bullhorn"></span>Agenda</label>
							<textarea rows="4" cols="50" class="form-control" name="agenda"
